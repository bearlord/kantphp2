...
class CaptchaAction extends Action {
     ...
     */
    public $fontFile = '@kant/Captcha/SpicyRice.ttf';
     ...
     */
    public function run() {
        if (Kant::$app->request->get(self::REFRESH_GET_VAR)) {
            // AJAX request for regenerating code
            $code = $this->getVerifyCode(true);
            Kant::$app->response->format = Response::FORMAT_JSON;
            return [
            ...
            $this->setHttpHeaders();
            Kant::$app->response->format = Response::FORMAT_RAW;
    ...
    public function validate($input, $caseSensitive) {
        ...
        $session->put($name, $session[$name] + 1);
        $session->save();
    ...
    protected function renderImageByGD($code) {
        ...
        $backColor = imagecolorallocate(
                $image, (int) ($this->backColor % 0x1000000 / 0x10000), (int) ($this->backColor % 0x10000 / 0x100), $this->backColor % 0x100
        );
        ...
        $foreColor = imagecolorallocate(
                $image, (int) ($this->foreColor % 0x1000000 / 0x10000), (int) ($this->foreColor % 0x10000 / 0x100), $this->foreColor % 0x100
        );
