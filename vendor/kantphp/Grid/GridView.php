...
use Kant\Kant;
use Closure;
use Kant\I18n\Formatter;
use Kant\Exception\InvalidConfigException;
use Kant\Helper\Url;
use Kant\Helper\Html;
use Kant\Helper\Json;
use Kant\Widget\BaseListView;
...
class GridView extends BaseListView
{
     ...
     *      Defaults to 'Kant\Grid\DataColumn'.
     */
     ...
     *      the [[\Kant\I18n\Formatter::nullDisplay|nullDisplay]] property of the [[formatter]] will
    ...
    public function init()
    {
        ...
        if ($this->formatter === null) {
            $this->formatter = Kant::$app->getFormatter();
    ...
    public function run()
    {
        ...
        $view->registerJs("jQuery('#$id').kantGridView($options);");
        parent::run();
    }
    ...
    {
        $filterUrl = isset($this->filterUrl) ? $this->filterUrl : Kant::$app->request->fullUrl();
    ...
    protected function initColumns()
    {
        ...
        foreach ($this->columns as $i => $column) {
            if (is_string($column)) {
                ...
                $column = Kant::createObject(array_merge([
