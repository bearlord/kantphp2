 ...
 *
 * ```javascript
 * var keys = $('#grid').kantGridView('getSelectedRows');
...
class CheckboxColumn extends Column
{
     ...
     * @inheritdoc
     * 
     * @throws \Kant\Exception\InvalidConfigException if [[name]] is not set.
     */
    ...
    public function registerClientScript()
    {
        ...
        $this->grid->getView()->registerJs("jQuery('#$id').kantGridView('setSelectionColumn', $options);");
    }
}
