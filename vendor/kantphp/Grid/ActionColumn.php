...
class ActionColumn extends Column {
     ...
     *
     * ```php
     * ['class' => 'Kant\Grid\ActionColumn', 'template' => '{view} {update}'],
     * ```
     *
     * @see buttons
     */
     ...
     * ```php
     * [
     *     'update' => \Kant::$app->user->can('update'),
     * ],
     * ```
     * @since 2.0.7
     */
    ...
    protected function initDefaultButtons() {
        ...
        $this->initDefaultButton('delete', 'trash', [
            'data-confirm' => Kant::t('kant', 'Are you sure you want to delete this item?'),
            'data-method' => 'post',
        ]);
    }
     ...
     * @param \Kant\Database\ActiveRecord $model the data model
    ...
    public function createUrl($action, $model, $key, $index) {
        if (is_callable($this->urlCreator)) {
            ...
            $dispatcher = Kant::$app->dispatcher;
            $dispatcher[2] = $action;
            return Url::to(implode("/", $dispatcher), $params);
