 ...
 * You can access that instance via `Kant::$app->errorHandler`.
 *
 ...
 * @since 2.0
 */
class ErrorHandler extends \Kant\Foundation\ErrorHandler
{
    /**
     ...
     * using `Kant::$app->errorHandler->exception`. This property defaults to null, meaning ErrorHandler
     ...
     */
    public $errorView = '@kant/View/errorHandler/error.php';
    /**
     * @var string the path of the view file for rendering exceptions.
     */
    public $exceptionView = '@kant/View/errorHandler/exception.php';
    /**
     * @var string the path of the view file for rendering exceptions and errors call stack element.
     */
    public $callStackItemView = '@kant/View/errorHandler/callStackItem.php';
    /**
     * @var string the path of the view file for rendering previous exceptions.
     */
    public $previousExceptionView = '@kant/View/errorHandler/previousException.php';
    /**
    ...
    protected function renderException($exception)
    {
        ...
        if ($useErrorView && $this->errorAction !== null) {
            $result = Kant::$app->runAction($this->errorAction);
    ...
    {
        if (!KANT_DEBUG && !$exception instanceof UserException && !$exception instanceof HttpException) {
            $exception = new HttpException(500, Kant::t('yii', 'An internal server error occurred.'));
        }
    ...
    public function renderFile($_file_, $_params_)
    {
        ...
        if ($this->exception instanceof ErrorException || !Kant::$app->has('view')) {
            ob_start();
            ob_implicit_flush(false);
            extract($_params_, EXTR_OVERWRITE);
            require(Kant::getAlias($_file_));

            return ob_get_clean();
        } else {
            return Kant::$app->getView()->renderFile($_file_, $_params_, $this);
        }
    }
