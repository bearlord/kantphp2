...
use Kant\Exception\UrlGenerationException;
...
class RouteUrlGenerator
{
     ...
     *
     * @param \Kant\Routing\UrlGenerator $url            
     ...
     * @return string
     *
     * @throws \Kant\Exceptions\UrlGenerationException
     */
    ...
    {
        return $this->addPortToDomain($this->getRouteScheme($route) . $route->domain());
    }
