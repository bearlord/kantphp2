...
class Icon {
    ...
    public function size($value) {
        return $this->addCssClass(
                        FontAwesome::$cssPrefix . '-' . $value, in_array((string) $value, [FontAwesome::SIZE_LARGE, FontAwesome::SIZE_2X, FontAwesome::SIZE_3X, FontAwesome::SIZE_4X, FontAwesome::SIZE_5X], true), sprintf(
                                '%s - invalid value. Use one of the constants: %s.', 'FA::size()', 'FA::SIZE_LARGE, FA::SIZE_2X, FA::SIZE_3X, FA::SIZE_4X, FA::SIZE_5X'
                        )
        );
    }
    ...
    public function rotate($value) {
        return $this->addCssClass(
                        FontAwesome::$cssPrefix . '-rotate-' . $value, in_array((string) $value, [FontAwesome::ROTATE_90, FontAwesome::ROTATE_180, FontAwesome::ROTATE_270], true), sprintf(
                                '%s - invalid value. Use one of the constants: %s.', 'FA::rotate()', 'FA::ROTATE_90, FA::ROTATE_180, FA::ROTATE_270'
                        )
        );
    }
    ...
    public function flip($value) {
        return $this->addCssClass(
                        FontAwesome::$cssPrefix . '-flip-' . $value, in_array((string) $value, [FontAwesome::FLIP_HORIZONTAL, FontAwesome::FLIP_VERTICAL], true), sprintf(
                                '%s - invalid value. Use one of the constants: %s.', 'FA::flip()', 'FA::FLIP_HORIZONTAL, FA::FLIP_VERTICAL'
                        )
        );
    }
