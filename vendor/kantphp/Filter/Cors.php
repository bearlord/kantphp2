 ...
 * return [
 * 'corsFilter' => [
 * 'class' => \Kant\Filter\Cors::className(),
 * ],
 * ];
 * }
 * ```
...
class Cors extends ActionFilter
{
    ...
    {
        $this->request = $this->request ?  : Kant::$app->getRequest();
        $this->response = $this->response ?  : Kant::$app->getResponse();
    ...
    public function prepareHeaders($requestHeaders)
    {
        ...
        if (isset($this->cors['Access-Control-Max-Age']) && Kant::$app->getRequest()->getIsOptions()) {
