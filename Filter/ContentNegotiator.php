...
use Kant\Foundation\BootstrapInterface;
use Kant\Exception\InvalidConfigException;
use Kant\Http\Response;
use Kant\Http\Request;
use Kant\Exception\UnsupportedMediaTypeHttpException;
 ...
 * If a match is found, the [[\Kant\Application::language]] property will be set as the chosen language.
 *
 ...
 * 'bootstrap' => [
 * [
 * 'class' => 'Kant\Filter\ContentNegotiator',
 * 'formats' => [
...
class ContentNegotiator extends ActionFilter implements BootstrapInterface
{
     ...
     *      as declared in [[\Kant\Http\Response::formatters]].
     *     
